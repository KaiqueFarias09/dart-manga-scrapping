...
import 'services/search_scrapper/search_scrapper.dart';

void main() {
  testSearchMangaScrapper();
}

testSearchMangaScrapper() {
  SearchMangasScrapper searchMangasScrapper = SearchMangasScrapper();
  searchMangasScrapper.scrapeSearchMangas(querySearch: "chainsaw man").then(
        (mangas) => {
          mangas.forEach(
            (manga) {
              print(manga.title);
...
testMangasScrapper() {
  ...
  mangasScrapper.scrapeMangas(genre: "artes-marciais").then(
        (mangas) => {
          mangas.forEach(
            (manga) {
              print(manga.title);
...
testMangaScrapper() {
  ...
  mangaScrapper.scrapeManga().then(
        (manga) => {
          print(manga.title),
          print(manga.image),
...
testChapterScrapper() {
  ...
  chapterScrapper.createChapterLinks().then(
        (chapterLinks) => chapterLinks.forEach(
          (link) {
            print(link);
          },
        ),
